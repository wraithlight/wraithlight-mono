...
export namespace  AuthAction {
    ...
    export const login = (
        username: string,
        password: string
    ): ActionWithPayload<{ username: string, password: string }> => ({
    ...
    export const loginSuccess = (
        token: string,
        validUntil: Date
    ): ActionWithPayload<{ token: string, validUntil: Date }> => ({
