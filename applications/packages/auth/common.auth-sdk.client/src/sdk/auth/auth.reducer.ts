...
export function initializeReducers(
  ...
  store.addReducer(
    ...
    (
      state,
      action: ActionWithPayload<Array<string>>
    ) => {
      return {
        ...state,
        auth: {
  ...
  store.addReducer(
    ...
    (
      state,
      action: ActionWithPayload<{ token: string, validUntil: Date }>
    ) => {
      return {
        ...state,
        auth: {
  ...
  store.addReducer(
    ...
    (
      state,
      _action: ActionWithPayload<{ token: string }>
    ) => {
      return {
        ...state,
        auth: {
      ...
      return {
        ...
        auth: {
          ...
          session: {
            ...
            isBusy: false,
            isLoggedIn: false,
            token: GLOBAL_UNDEFINED,
            tokenValidUntil: GLOBAL_UNDEFINED
          }
        }
      };
    }
